...
> 由 [AGENTS.md L49-50](../../AGENTS.md#L49) 锚定的浏览器自动化与认证态使用协议。本协议是工程行为准则的子集，**任何 AI Agent 在执行浏览器自动化任务前必须完整遵循**。
>
...
- 本协议章节可被 [AGENTS.md](../../AGENTS.md) / [CLAUDE.md](../../CLAUDE.md) 通过 `#L<行号>` 或 `#章节锚点` 形式引用
- 修订本协议**必须**在 [docs/issue.md](../issue.md) 留存背景与决策记录
- 协议条款发生变更时，需同步检查 [AGENTS.md L49-50](../../AGENTS.md#L49) 的兜底原则与本协议是否一致
